...
class _BaseIP(_IPAddrBase):
    ...
    def __init__(self, address):
        if (not (_compat_has_real_bytes and isinstance(address, bytes)) and
                '/' in str(address)):
...
class IPv4Network(_BaseV4, _BaseNet):
    ...
    # backwards compatibility
    def IsRFC1918(self): return self.is_private

    def IsMulticast(self): return self.is_multicast

    def IsLoopback(self): return self.is_loopback

    def IsLinkLocal(self): return self.is_link_local
