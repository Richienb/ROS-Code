...
class AssAttr(Node):
    ...
    def __repr__(self):
        return "AssAttr(%s, %s, %s)" % (repr(self.expr),
                                        repr(self.attrname), repr(self.flags))
...
class CallFunc(Node):
    ...
    def __repr__(self):
        return "CallFunc(%s, %s, %s, %s)" % (repr(self.node), repr(
            self.args), repr(self.star_args), repr(self.dstar_args))
...
class Class(Node):
    ...
    def __repr__(self):
        return "Class(%s, %s, %s, %s, %s)" % (repr(self.name), repr(
            self.bases), repr(self.doc), repr(self.code), repr(self.decorators))
...
class Exec(Node):
    ...
    def __repr__(self):
        return "Exec(%s, %s, %s)" % (repr(self.expr),
                                     repr(self.locals), repr(self.globals))
...
class For(Node):
    ...
    def __repr__(self):
        return "For(%s, %s, %s, %s)" % (repr(self.assign), repr(
            self.list), repr(self.body), repr(self.else_))
...
class From(Node):
    ...
    def __repr__(self):
        return "From(%s, %s, %s)" % (repr(self.modname),
                                     repr(self.names), repr(self.level))
...
class Function(Node):
    ...
    def __repr__(self):
        return "Function(%s, %s, %s, %s, %s, %s, %s)" % (repr(
            self.decorators),
            repr(
            self.name),
            repr(
...
class IfExp(Node):
    ...
    def __repr__(self):
        return "IfExp(%s, %s, %s)" % (repr(self.test),
                                      repr(self.then), repr(self.else_))
...
class Lambda(Node):
    ...
    def __repr__(self):
        return "Lambda(%s, %s, %s, %s)" % (repr(self.argnames), repr(
            self.defaults), repr(self.flags), repr(self.code))
...
class ListCompFor(Node):
    ...
    def __repr__(self):
        return "ListCompFor(%s, %s, %s)" % (
            repr(self.assign), repr(self.list), repr(self.ifs))
...
class DictComp(Node):
    ...
    def __repr__(self):
        return "DictComp(%s, %s, %s)" % (
            repr(self.key), repr(self.value), repr(self.quals))
...
class Raise(Node):
    ...
    def __repr__(self):
        return "Raise(%s, %s, %s)" % (repr(self.expr1),
                                      repr(self.expr2), repr(self.expr3))
...
class Slice(Node):
    ...
    def __repr__(self):
        return "Slice(%s, %s, %s, %s)" % (repr(self.expr), repr(
            self.flags), repr(self.lower), repr(self.upper))
...
class Subscript(Node):
    ...
    def __repr__(self):
        return "Subscript(%s, %s, %s)" % (
            repr(self.expr), repr(self.flags), repr(self.subs))
...
class TryExcept(Node):
    ...
    def __repr__(self):
        return "TryExcept(%s, %s, %s)" % (
            repr(self.body), repr(self.handlers), repr(self.else_))
...
class With(Node):
    ...
    def __repr__(self):
        return "With(%s, %s, %s)" % (repr(self.expr),
                                     repr(self.vars), repr(self.body))
