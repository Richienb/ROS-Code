...
class Stats:
    ...
    def load_stats(self, arg):
        if not arg:
            ...
            except BaseException:  # in case this is not unix
                pass
            self.files = [arg]
    ...
    def add(self, *arg_list):
        ...
        if not isinstance(
                self,
                type(other)) or self.__class__ != other.__class__:
            other = Stats(other)
        ...
        for func in clist:
            ...
            if isinstance(value, tuple):
                ...
                if nc != cc:
                    ...
                    substats = '%d' % (nc,)
                substats = '%s %s %s  %s' % (substats.rjust(
                    7 + 2 * len(indent)), f8(tt), f8(ct), name)
