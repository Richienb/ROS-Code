...
class ComplexTest(unittest.TestCase):
    ...
    def test_div(self):
        ...
        simple_complex = [complex(x, y)
                          for x in simple_real for y in simple_real]
    ...
    def test_richcompare(self):
        self.assertEqual(complex.__eq__(1 + 1j, 1 << 10000), False)
    ...
    def test_abs(self):
        nums = [complex(x / 3., y / 7.) for x in xrange(-9, 9)
                for y in xrange(-9, 9)]
        for num in nums:
            self.assertAlmostEqual(
    ...
    def test_format(self):
        ...
        self.assertEqual(format(1.5 + 3j, '>20.2f'), '          1.50+3.00j')
        self.assertEqual(format(1.5 + 3j, '<20.2f'), '1.50+3.00j          ')
        self.assertEqual(format(1.5e20 + 3j, '<20.2f'),
        ...
        self.assertEqual('*{0:.3f}*'.format(3.14159 +
                                            2.71828j), '*3.142+2.718j*')
