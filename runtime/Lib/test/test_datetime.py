...
class TestTZInfo(unittest.TestCase):
    ...
    def test_pickling_subclass(self):
        ...
        self.assertTrue(isinstance(orig, PicklableFixedOffset))
        ...
        for pickler, unpickler, proto in pickle_choices:
            ...
            self.assertTrue(isinstance(derived, PicklableFixedOffset))
...
class TestTimeDelta(HarmlessMixedComparison, unittest.TestCase):
    ...
    def test_subclass_timedelta(self):
        ...
        t1 = T(days=1)
        self.assertTrue(isinstance(t1, T))
        self.assertEqual(t1.as_hours(), 24)

        t2 = T(days=-1, seconds=-3600)
        self.assertTrue(isinstance(t2, T))
        self.assertEqual(t2.as_hours(), -25)

        t3 = t1 + t2
        self.assertTrue(isinstance(t3, timedelta))
        t4 = T.from_td(t3)
        self.assertTrue(isinstance(t4, T))
...
class TestDateTimeTZ(TestDateTime, TZInfoBase, unittest.TestCase):
    ...
    def test_tzinfo_timetuple(self):
        ...
        # dst() at the edge.
        self.assertEqual(
            cls(1, 1, 1, tzinfo=DST(1439)).timetuple().tm_isdst, 1)
        self.assertEqual(
            cls(1, 1, 1, tzinfo=DST(-1439)).timetuple().tm_isdst, 1)
        ...
        self.assertRaises(ValueError, cls(
            1, 1, 1, tzinfo=DST(-1440)).timetuple)
