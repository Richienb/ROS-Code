...
try:
    ...
    def check_deprecated_module(module_name):
        ...
        """
        return any(module_name in msg and ' removed' in msg and
                   issubclass(cls, DeprecationWarning) and
...
class TestPy3KWarnings(unittest.TestCase):
    ...
    def test_file_xreadlines(self):
        ...
        with file(__file__) as f:
            with check_py3k_warnings() as w:
                self.assertWarning(f, w, expected)
    ...
    def test_hash_inheritance(self):
        with check_py3k_warnings() as w:
            ...
            self.assertWarning(
                None, w, "Overriding __eq__ blocks inheritance of __hash__ in 3.x")
            w.reset()
