...
class StrftimeTest(unittest.TestCase):
    ...
    def _update_variables(self, now):
        ...
        self.jan1 = time.localtime(time.mktime(
            (now[0], 1, 1, 0, 0, 0, 0, 1, 0)))
    ...
    def strftest1(self, now):
        ...
        for e in expectations:
            ...
            try:
                ...
                self.fail(
                    "strftime '%s' format gave error: %s" %
                    (e[0], error))
    ...
    def strftest2(self, now):
        ...
        nonstandard_expectations = (
            ...
            ('%D', '%02d/%02d/%02d' %
             (now[1], now[2], (now[0] % 100)), 'mm/dd/yy'),
            ('%e', '%2d' %
             now[2], 'day of month as number, blank padded ( 0-31)'),
