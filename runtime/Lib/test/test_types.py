...
class TypesTests(unittest.TestCase):
    ...
    def test_truth_values(self):
        ...
        if 0:
            self.fail('0L is true instead of false')
        if 0.0:
    ...
    def test_numeric_types(self):
        ...
        if long(1.9) == 1 == long(1.1) and long(-1.1) == -1 == long(-1.9):
            pass
        else:
    ...
    def test_float__format__locale(self):
        ...
        for i in range(-10, 10):
            ...
            self.assertEqual(
                locale.format(
                    '%g', x, grouping=True), format(
                    x, 'n'))
            self.assertEqual(
                locale.format(
                    '%.10g', x, grouping=True), format(
                    x, '.10n'))
